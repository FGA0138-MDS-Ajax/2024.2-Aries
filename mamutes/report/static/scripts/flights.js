...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const openModalBtn = document.getElementById("editBtFlight");
    const modal = document.getElementById("modalEditFlightEdit");
    const closeModalBtn = document.getElementById("closeModalBtnEdit");

    const closeModalBtnDois = document.getElementById("modalEditFlight");
